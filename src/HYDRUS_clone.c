...
/* ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||* */
/* Main program */ 
int R_MAIN__(const char *options_in, const char *selector_in,  const char *atmosph_in,
             const char *profile_dat, const char *outdir, int printOut)
{
    /* Initialized data */
    ...
    static real cap[1001], rad, r_h__, aqh, bqh, ath[1001], aks[1001], con[
	    1001], ahw[20], akw[20];
    static integer err;
    static real rkm, rgr, rnl, thr[20], ths[20], rns, rst;
    ...
    extern /* Subroutine */ int initdualpor_(integer *, integer *, integer *, 
	    ...
	    real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, real *, logical *);
    static real area[10], rh_a__, beta[1001], htab[2000]	/* was [100][
	    20] */;
    static integer ilai;
    ...
    static real hold[1001], pard[220]	/* was [11][20] */, cbot[11], ampl, 
	    pecr, cnew[1001], tdep[180], cono[1001], hsat[20], disp[1001], 
	    hnew[1001];
    ...
    static real parw[220]	/* was [11][20] */, ctop[11], tpar[200]	/* 
	    was [10][20] */, sorb[11011]	/* was [11][1001] */, athw[20]
	    , vnew[1001], aths[1001], thrr[1001], conr[1001], theq[1001], 
	    wdep[2178]	/* was [22][99] */;
    ...
    static real tauw;
    static logical lupw;
    static real spot, tolh, rtop, rbot;
    static integer nmat, nlay, iver, nobs;
    static real htop, hbot;
    extern /* Subroutine */ int hyst_(integer *, integer *, real *, real *, 
	    integer *, integer *, real *, real *, real *, real *, real *, 
	    integer *, integer *);
    static real cvch0[11], cvch1[11];
    static shortint i100th;
    extern /* Subroutine */ int tmin_(doublereal *, doublereal *, doublereal *
	    , doublereal *, real *, real *, real *, real *, real *, 
	    doublereal *, doublereal *, real *, logical *, logical *, logical 
	    *, integer *, integer *, integer *, real *, integer *, logical *, 
	    integer *, logical *, integer *, doublereal *, logical *, logical 
	    *, logical *, logical *, real *, integer *);
    static real dmul, rlat, ralt, xlai, ttop, tbot;
    static integer ierr;
    static real epsi, catm, prec, radn, rado, dmul2, wind, gwl0l;
    static doublereal tatm1, tatm2;
    static real sorb2[11011]	/* was [11][1001] */, tmin1, tmax1;
    ...
    static real chpar[3600]	/* was [180][20] */, precc, cumch[110]	/* 
	    was [10][11] */;
    ...
    static real dtmax, dtmin, sorbn2[1001];
    ...
    static real ctola, ctolr, dsurf, geofac, rsoil, albedo;
    extern /* Subroutine */ int meteo_(integer *, logical *, logical *, 
	    ...
	    real *, real *, real *, real *, real *, real *, real *, integer *)
	    ;
    static real evapp, windn, captab[2000]	/* was [100][20] */, omegac, 
	    windo;
    static logical lenbal;
    static real xlain, tmaxn, tmaxo, tminn;
    ...
    static real tpulse, transp, etcomb, xrootn, tmaxan, tminan, tmino, tempa, 
	    tmaxa, tmaxao, tmina, tminao, rhmean, rhmax;
    static doublereal tprint1;
    static real rhmaxn, rhmaxo, albedon;
    static integer ienhanc;
    static real rhmin, rhminn, rhmino, eamean, eameann, dtsnow, rrootd, 
	    rsoild;
    ...
    extern /* Subroutine */ int subreg_(integer *, integer *, integer *, real 
	    *, real *, real *, real *, integer *, integer *, doublereal *, 
	    real *, real *, real *, logical *, real *, real *, integer *, 
	    real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, logical *, logical *, real *, real *, real *, integer *, 
	    integer *, real *, logical *, logical *, logical *, integer *, 
	    real *, real *, logical *, logical *, real *, logical *, real *, 
	    real *, logical *, real *, real *, real *, integer *, real *, 
	    real *, logical *, logical *, real *, logical *, real *);
    static integer ntabmod;
    static real ainterc;
    static logical llinear[11];
    static real wvoli, rhmeann, shwrada, shwradb;
    static logical lscreen, lomegaw;
    static real rlwrada, rlwradb;
    static integer iinterc;
    static real tholdim[1001];
    ...
    extern /* Subroutine */ int veloc_(integer *, real *, real *, real *, 
	    ...
	    logical *, real *, real *, real *, real *, real *, real *, real *,
	     logical *, real *, integer *, logical *, real *), getdat_(
	    shortint *, shortint *, shortint *), gettim_(shortint *, shortint 
	    *, shortint *, shortint *);
    static integer ngrowth, itemp;
    static real epsit;
    static integer nprstep;
    static real rgrowth[5000]	/* was [1000][5] */, temps;
    ...
    static real dummy1, dummy2, rlwrada1, rlwradb1;
    extern /* Subroutine */ int obsnod_(doublereal *, integer *, integer *, 
	    integer *, integer *, integer *, real *, real *, real *, real *, 
	    logical *, real *, real *, real *, logical *, integer *), alinf_(
...
/* GETARG had a 3rd arugment: , status */
    ...
    ilengthpath = strlen(outdir);
    sprintf(cdatapath, "%s", outdir);

/* Writing concatenation */
//    i__2[0] = ilengthpath, a__1[0] = cdatapath;
//    i__2[1] = 10, a__1[1] = options_in;
//    s_cat(cfilename, a__1, i__2, &c__2, (ftnlen)260);
    o__1.oerr = 1;
    o__1.ounit = 35;
    o__1.ofnmlen = 260;
    o__1.ofnm = options_in;
    o__1.orl = 0;
    o__1.osta = "old";
    o__1.oacc = 0;
    o__1.ofm = 0;
...
/*     Initialization */
    ...
    lscreen = lprint = lprintd = printOut;

/* Writing concatenation */
//    i__2[0] = ilengthpath, a__1[0] = cdatapath;
//    i__2[1] = 11, a__1[1] = selector_in;
//    s_cat(cfilename, a__1, i__2, &c__2, (ftnlen)260);
    o__1.oerr = 1;
    o__1.ounit = 30;
    o__1.ofnmlen = 260;
    o__1.ofnm = selector_in;
    o__1.orl = 0;
    o__1.osta = "old";
    o__1.oacc = 0;
    o__1.ofm = 0;
...
/* Writing concatenation */
//    i__2[0] = ilengthpath, a__1[0] = cdatapath;
//    i__2[1] = 11, a__1[1] = profile_dat;
//    s_cat(cfilename, a__1, i__2, &c__2, (ftnlen)260);
    o__1.oerr = 1;
    o__1.ounit = 32;
    o__1.ofnmlen = 260;
    o__1.ofnm = profile_dat;
    o__1.orl = 0;
    o__1.osta = "old";
    o__1.oacc = 0;
    o__1.ofm = 0;
...
/* Writing concatenation */
    i__2[0] = ilengthpath, a__1[0] = outdir;
    i__2[1] = 11, a__1[1] = "I_CHECK.OUT";
    s_cat(cfilename, a__1, i__2, &c__2, (ftnlen)260);
    o__1.oerr = 1;
    o__1.ounit = 50;
    o__1.ofnmlen = 260;
...
/* Writing concatenation */
	    i__2[0] = ilengthpath, a__1[0] = cdatapath;
	    i__2[1] = 13, a__1[1] = "NOD_INF_V.OUT";
	    s_cat(cfilename, a__1, i__2, &c__2, (ftnlen)260);
	    o__1.oerr = 1;
	    o__1.ounit = 45;
	    o__1.ofnmlen = 260;
...
/* Writing concatenation */
//	i__2[0] = ilengthpath, a__1[0] = cdatapath;
//	i__2[1] = 10, a__1[1] = "ATMOSPH.IN";
//	s_cat(cfilename, a__1, i__2, &c__2, (ftnlen)260);
	o__1.oerr = 1;
	o__1.ounit = 31;
	o__1.ofnmlen = 260;
	o__1.ofnm = atmosph_in;
	o__1.orl = 0;
	o__1.osta = "old";
	o__1.oacc = 0;
	o__1.ofm = 0;
...
// Is this the end of the reading input.
...
/* L11: */
    ...
    getdat_(&iyear, &imonth, &iday);
    gettim_(&ihours, &imins, &isecs, &i100th);
...
/*     New updated values */
    ...
    if(RCallbackRoutine) {
	if(RCallbackRoutine(t, numnp, lwat, lchem, vold, vnew, thvold, thvnew, &tmax) < 0) { //, hold, hnew, vvold, vvnew);
	    lend = TRUE; // end the loop 
	    return(0);  // a little severe in case there are any things we need to cleanup in remaining code.
	}
    }
